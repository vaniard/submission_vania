...
with col1:
    ...
    season_names_id = {'spring': 'Semi', 'summer': 'Panas', 'fall': 'Gugur', 'winter': 'Dingin'}
...
with col1:
    ...
    weather_names_id = {'clear': 'Cerah', 'mist': 'Berkabut', 'light rain': 'Hujan Ringan'}
...
with col1:
    ...
    day_type_names = {'weekday': 'Hari Kerja', 'weekend': 'Akhir Pekan'}
...
with col1:
    ...
    temp_names = {'Cold': 'Dingin', 'Mild': 'Sedang', 'Warm': 'Hangat', 'Hot': 'Panas'}
...
with col2:
    ...
    hum_names = {'Low Humidity': 'Rendah', 'Medium Humidity': 'Sedang', 'High Humidity': 'Tinggi'}
